...
| ARK Pixhawk Debug Adapter | [store](https://arkelectron.com/product/ark-pixhawk-debug-adapter/) | No published CAD or drawings. |
| L1/L5 GNSS Antenna | [store](https://arkelectron.com/product/l1-l5-gnss-antenna/) | No CAD or documentation published for this product. A reference STL of the BT-T076 helical antenna is included under the `antenna/` directories of the G5 / MOSAIC-X5 / X20 RTK GPS products, but ARK's pages don't confirm it is this exact product. |
